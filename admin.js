  ...
  const samples = [
    {
      ...
      constructionLog:[
        {date:"18 Mar 2026", activity:"Setting Out Complete", description:"Grid lines C/4 to C/6 confirmed against datum. Column positions marked. Levels checked to +4.200m.", recordedBy:"Site Engineer", status:"Complete"},
        {date:"24 Mar 2026", activity:"Formwork Delivery", description:"Formwork panels delivered by Alsford Timber. 35.66 m2 of panels received in good condition.", recordedBy:"Site Foreman", status:"Complete"},
        {date:"28 Mar 2026", activity:"Formwork Erected", description:"Formwork panels erected and props checked by Temporary Works Engineer. All levels verified.", recordedBy:"Temp Works Eng.", status:"Complete"},
        {date:"29 Mar 2026", activity:"Rebar Delivery", description:"Steel reinforcement delivered with mill certificates. Batch ASS-PHI25-0322, 1,206.99 kg B500C.", recordedBy:"Site Engineer", status:"Complete"},
        {date:"05 Apr 2026", activity:"Rebar Fixing In Progress", description:"Bottom 8 phi25 bars positioned. Top bars being fixed. Expected completion 08 Apr.", recordedBy:"Steel Fixer", status:"Complete"},
        {date:"10 Apr 2026", activity:"Pre-Pour Inspection", description:"Final rebar cage inspection completed. Concrete cover verified at all locations. Green light for pour.", recordedBy:"Lead Structural Eng.", status:"Complete"},
        {date:"22 Apr 2026", activity:"Concrete Pour", description:"5.99m3 C35/45 placed via ready-mix truck. Slump test passed at 80mm (S3). 4 cube samples taken.", recordedBy:"Site Engineer", status:"Complete"},
        {date:"22 Apr 2026", activity:"Curing Commenced", description:"Polythene sheeting applied over concrete surface. Curing commenced under controlled conditions.", recordedBy:"Site Foreman", status:"Complete"},
      ],
      deliveries:[
        ...
        {material:"Steel Reinforcement B500C", supplier:"A. Steadman and Son, Nottingham", batchId:"ASS-PHI25-0322", quantity:"1,206.99 kg", date:"29 Mar 2026", status:"Delivered and fixing in progress"},
      ...
      issues:[
        {id:"ISS-001", title:"Concrete cover below minimum at bottom bars — midspan location", identified:"10 Apr 2026 — Site Engineer", description:"Cover measured at 28mm against minimum 30mm. One spacer had shifted during final inspection.", action:"Additional spacer installed, cover confirmed at 31mm. Re-inspected and approved.", standard:"EN 1992-1-1 S4.4.1", status:"Resolved"},
      ],
      progressHistory:[
        ...
        {date:"18 Mar 2026, 14:30", progress:"10", status:"In Progress - Setting Out", activity:"Grid lines C/4 to C/6 confirmed and marked on site", updatedBy:"Site Engineer"},
        {date:"28 Mar 2026, 16:00", progress:"25", status:"In Progress - Formwork", activity:"Formwork panels erected — props being checked", updatedBy:"Temp. Works Eng."},
        {date:"05 Apr 2026, 11:00", progress:"40", status:"In Progress - Rebar Fixing", activity:"Bottom bars positioned — top bars being fixed", updatedBy:"Steel Fixer"},
        {date:"10 Apr 2026, 09:30", progress:"55", status:"In Progress - Pre-Pour", activity:"Final rebar cage inspection — cover being verified", updatedBy:"Site Engineer"},
        {date:"22 Apr 2026, 16:00", progress:"75", status:"In Progress - Curing", activity:"Concrete curing under polythene sheeting", updatedBy:"Site Engineer"},
      ],
    },
